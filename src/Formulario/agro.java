...
public final class agro extends javax.swing.JInternalFrame {
    int resp,canti;
    Double pree;
    public agro() {
        initComponents();
        setTitle("Agregar Ropa");
    }
    ...
    private void initComponents() {
        ...
        co_bu.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Seleccionar", "CH", "M", "G", "XG" }));
        ...
        jPanel1.add(co_bu, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 130, 160, 30));

        cant.setFont(new java.awt.Font("Comic Sans MS", 0, 20)); // NOI18N
        cant.setModel(new javax.swing.SpinnerNumberModel());
        jPanel1.add(cant, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 190, 140, 30));

        Cantidad1.setFont(new java.awt.Font("Comic Sans MS", 0, 20)); // NOI18N
        Cantidad1.setForeground(new java.awt.Color(255, 255, 255));
        Cantidad1.setText("Talla:");
        jPanel1.add(Cantidad1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 130, -1, -1));

        txt_nom.setFont(new java.awt.Font("Comic Sans MS", 0, 20)); // NOI18N
        jPanel1.add(txt_nom, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 60, 150, 40));
        ...
        jPanel1.add(pre, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 270, 140, 30));

        Precio.setFont(new java.awt.Font("Comic Sans MS", 0, 20)); // NOI18N
        Precio.setForeground(new java.awt.Color(255, 255, 255));
        Precio.setText("Precio:");
        jPanel1.add(Precio, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 270, -1, -1));

        Cantidad.setFont(new java.awt.Font("Comic Sans MS", 0, 20)); // NOI18N
        Cantidad.setForeground(new java.awt.Color(255, 255, 255));
        Cantidad.setText("Cantidad:");
        jPanel1.add(Cantidad, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 190, -1, -1));

        Nombre.setFont(new java.awt.Font("Comic Sans MS", 0, 20)); // NOI18N
        Nombre.setForeground(new java.awt.Color(255, 255, 255));
        Nombre.setText("Nombre:");
        jPanel1.add(Nombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 70, -1, -1));
        ...
        Fondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/agro.png"))); // NOI18N
    ...
    private void bo_ag1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bo_ag1ActionPerformed
        ...
        String tipo = "Ropa";
        try{
            if(!nom.equals("") && !pr.equals("0") && !ca.equals("0") && !n.equals("") && !con.equals("Seleccionar")){
                ...
                if(resp==0){
                    ...
                    Txt_de.setText("");
                    txt_ag.setText("");
                    co_bu.setSelectedItem("Seleccionar");
                }
                else if(resp==1){
                    Connection cn = Conexion.conectar();
                    PreparedStatement pst = cn.prepareStatement("insert into producto values(?,?,?,?,?,?,?,?)");
